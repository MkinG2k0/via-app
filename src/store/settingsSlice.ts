...
const settingsSlice = createSlice({
	...
	reducers: {
		...
		updateDesignDefinitionVersion: (state, action: PayloadAction<DefinitionVersion>) => {
		...
		setMacroEditorSettings: (state, action: PayloadAction<Partial<MacroEditorSettings>>) => {
			const macroEditor = {
				...state.macroEditor,
				...action.payload,
			}
		...
		setTestKeyboardSoundsSettings: (state, action: PayloadAction<Partial<TestKeyboardSoundsSettings>>) => {
...
export const getDesignDefinitionVersion = (state: RootState) => state.settings.designDefinitionVersion
...
export const getMacroEditorSettings = (state: RootState) => state.settings.macroEditor
export const getTestKeyboardSoundsSettings = (state: RootState) => state.settings.testKeyboardSoundsSettings
export const getRenderMode = (state: RootState) => (webGLIsAvailable ? state.settings.renderMode : '2D')
...
export const getSelectedSRGBTheme = createSelector(getSelectedTheme, (selectedTheme) => {

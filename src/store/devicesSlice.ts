...
const deviceSlice = createSlice({
	...
	reducers: {
		...
		ensureSupportedIds: (state, action: PayloadAction<{ productIds: number[]; version: DefinitionVersion }>) => {
...
export const getForceAuthorize = (state: RootState) => state.devices.forceAuthorize
...
export const getSelectedKeyboardAPI = createSelector(getSelectedDevicePath, (path) => path && new KeyboardAPI(path))

...
export const { updateSelectedDefinitionIndex, updateSelectedOptionKeys, updateShowMatrix } = designSlice.actions

export default designSlice.reducer

export const getSelectedDefinitionIndex = (state: RootState) => state.design.selectedDefinitionIndex

export const getDesignSelectedOptionKeys = (state: RootState) => state.design.selectedOptionKeys

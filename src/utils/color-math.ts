...
export const updateCSSVariables = (themeName: keyof typeof THEMES) => {
	...
	document.documentElement.style.setProperty('--color_accent', selectedTheme.accent.c)
	document.documentElement.style.setProperty('--color_inside-accent', selectedTheme.accent.t)
}

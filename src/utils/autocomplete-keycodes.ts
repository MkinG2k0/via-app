...
export const getAutocompleteKeycodes = () =>
	keycodesList.filter((keycode) => Boolean(autocompleteKeycodes[keycode.code as keyof typeof autocompleteKeycodes]))
export function isAutocompleteKeycode(keycode: string): boolean {
	const key = keycode.toUpperCase()
	return Boolean(autocompleteKeycodes[key as keyof typeof autocompleteKeycodes])
}

...
function definitionExists({ productId, vendorId }: Device, definitions: KeyboardDictionary) {
...
export const getRecognisedDevices = async (vpidMap: VendorProductIdMap, forceRequest = false) => {

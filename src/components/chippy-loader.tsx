		...
		>
			...
			<g id={'Layer_2_00000088814685506851870240000015950599998114990989_'}>
				<g id={'Feet'}>
					<path
						d={
							'M169.7 432.1c28.3 0 51.5 23.3 51.5 51.5s-23.3 51.5-51.5 51.5-51.5-23.3-51.5-51.5 23.2-51.5 51.5-51.5zM425.8 432.1c28.3 0 51.5 23.3 51.5 51.5s-23.3 51.5-51.5 51.5-51.5-23.3-51.5-51.5 23.2-51.5 51.5-51.5z'
						}
					/>
				</g>
				<g id={'Body'}>
				...
				<g id={'Bowties'}>
					<path className={'st4'} d={'m293.7 356.6 73.5-33.7v67.3l-73.5-33.6zM293.7 356.6l-73.5 33.7V323l73.5 33.6z'} />
				</g>
			</g>
			<g
				id={'Layer2'}
			...
			>
				...
				<path
					className={'st7'}
					d={
						'M6.7 278.6c2.5-2.6 5.8-2.5 5.8-2.5v63.2s-3.9.4-7.1-4c-.7-.7-3.4-5.1-3.4-11.3v-32.4c0-6.9 2.7-10.9 4.7-13z'
					}
				/>
				<path
					className={'st9'}
				...
				<path
					className={'st7'}
					d={
						'M563.7 278.6c2.5-2.6 5.8-2.5 5.8-2.5v63.2s-3.9.4-7.1-4c-.7-.7-3.4-5.1-3.4-11.3v-32.4c0-6.9 2.7-10.9 4.7-13z'
					}
				/>
				<path
					className={'st9'}
...
export default function ChippyLoader(props: Props) {
	...
	const [containerHeight, containerWidth] = [height + containerPadding * 2, width + containerPadding * 2]

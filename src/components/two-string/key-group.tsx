...
import { CSSVarObject, calculateKeyboardFrameDimensions, getComboKeyProps } from 'src/utils/keyboard-rendering'
...
export const KeyGroup: React.FC<KeyGroupProps<React.MouseEvent>> = (props) => {
	...
	return (
		<KeyGroupContainer height={height} style={{ pointerEvents: props.selectable ? 'all' : 'none' }} width={width}>
			{elems}
		</KeyGroupContainer>
	)
}

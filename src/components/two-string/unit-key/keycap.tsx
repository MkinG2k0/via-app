...
export const Keycap: React.FC<TwoStringKeycapProps> = React.memo((props) => {
	...
	const redraw = React.useCallback(() => {
		if (
			...
			const doesOverflow = paintKeycap(canvasRef.current, textureWidth, textureHeight, color.t, label)
	...
	const keycapColor =
		DisplayMode.Test === mode
			...
			: pressedState === KeycapState.Unpressed
				? 'lightgrey'
				: 'lightgrey'
	const keycapOpacity = pressedState === KeycapState.Unpressed ? (wasPressed ? 0.4 : 0) : 0.6

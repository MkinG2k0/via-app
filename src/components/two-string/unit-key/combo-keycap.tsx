			...
			<KeycapContainer {...otherProps}>
				...
				>
					<ComboKeyRectContainer
						style={{
							...
							transform: `translate(${CSSVarObject.keyXPos * r1[0]}px,${CSSVarObject.keyYPos * r1[1]}px)`,
					...
					<ComboKeyRectContainer
						style={{
							position: 'absolute',
							borderRadius: 3,
							transform: `translate(${CSSVarObject.keyXPos * r2[0]}px,${CSSVarObject.keyYPos * r2[1]}px)`,
							background: getDarkenedColor(props.color.c, 0.8),
					...
					<ComboKeyBGContainer
						style={{
							...
							borderRadius: 3,
							background: getDarkenedColor(props.color.c, 0.8),
							transform: `translate(${CSSVarObject.keyXPos * r1[0] + 1}px,${1 + CSSVarObject.keyYPos * r1[1]}px)`,
					...
					<CanvasContainer
						style={{
							...
							position: 'absolute',
							transform: `translate(${CSSVarObject.keyXPos * r1[0] + CSSVarObject.faceXPadding[0]}px,${
					...
					<CanvasContainer
						style={{
							...
							background: props.color.c,
							position: 'absolute',
							transform: `translate(${CSSVarObject.keyXPos * r2[0] + CSSVarObject.faceXPadding[0]}px,${
					...
					<CanvasContainerBG
						style={{
							...
							background: props.color.c,
							position: 'absolute',
							transform: `translate(${1 + CSSVarObject.keyXPos * r1[0] + CSSVarObject.faceXPadding[0]}px,${
				...
				{(props.macroData || props.overflowsTexture) && (
					<TooltipContainer $rotate={props.rotation[2]}>
						<Keycap2DTooltip>{props.macroData || (props.label && props.label.tooltipLabel)}</Keycap2DTooltip>
					</TooltipContainer>
				)}
			</KeycapContainer>
		</>

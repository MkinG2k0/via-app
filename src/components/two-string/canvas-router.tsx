...
const KeyboardBG = styled.div<{
	...
	left: 0;
	background: ${(props) =>
		`linear-gradient(30deg, rgba(150,150,150,1) 10%,${getDarkenedColor(props.$color)} 50%, rgba(150,150,150,1) 90%)`};
		...
		<>
			...
			>
				{hideCanvasScene ? null : (
					<>
						<KeyboardBG $color={accentColor} $visible={!hideTerrainBG} onClick={terrainOnClick} />
						<KeyboardGroup
	...
	return (
		<>
			<KeyboardRouteGroup $position={0}>
				<ConfigureKeyboard dimensions={dimensions} nDimension={'2D'} selectable={configureKeyboardIsSelectable} />
			</KeyboardRouteGroup>

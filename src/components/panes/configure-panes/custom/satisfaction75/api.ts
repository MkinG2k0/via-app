...
export const setEncoderModes = async (api: KeyboardAPI, newEncoderModes: number) => {
...
export const setDefaultOLED = async (api: KeyboardAPI, newDefaultMode: number) => {
...
export const getCustomEncoderConfig = async (api: KeyboardAPI, encoderIdx: number): Promise<EncoderBehavior> => {
